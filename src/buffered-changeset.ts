...
import { notifierForEvent } from './-private';
import { defaultValidatorFn, defaultOptions, keys } from './-private/utils/consts';
import maybeUnwrapProxy from './-private/utils/maybe-unwrap-proxy';
import {
  CONTENT,
  PREVIOUS_CONTENT,
  CHANGES,
...
export class BufferedChangeset implements IChangeset {
  ...
  prepare(prepareChangesFn: PrepareChangesFn): this {
    ...
    let newObj: Changes = {};
    if (typeof preparedChanges === 'object') {
